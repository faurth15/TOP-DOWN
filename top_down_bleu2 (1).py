...
best_bleu2 = 0.  # BLEU-4 score right now
...
def main():
    ...
    global best_bleu2, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, word_map
...
if __name__ == '__main__':
    beam_size = 3
    print("\nBLEU-2 score @ beam size of %d is %.4f." % (beam_size, evaluate(beam_size)))
